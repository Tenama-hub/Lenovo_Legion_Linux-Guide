...
A secondary option is the [install app by LinuxGamerLife](https://github.com/linuxgamerlife/lgl-system-loadout). Avoid installing the CachyOS kernel unless you absolutely need it.<br>
Honorable mentions: [Noble guide](https://github.com/wz790/Fedora-Noble-Setup) <br>
| Tweak Name | Command/Link |
| ------------- | ------------- |
| **Enable 3rd party repositories** | Enable them after install or use the command below:<br>`sudo dnf install https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm && sudo dnf install https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm`  |
| **Enable full flatpak access** | `flatpak remote-delete fedora && flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo` |
